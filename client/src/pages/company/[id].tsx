  ...
  useEffect(() => {
    if (isMounted && typeof window !== 'undefined' && company?.id) {
      ...
      const recentCompany = {
        ...
        logo_url: company.logo || undefined,
        viewedAt: new Date().toISOString()
      };
      addRecentlyViewedCompany(recentCompany);
    }
  }, [company?.id, isMounted, company]);
            ...
            <Grid container spacing={3} alignItems="center">
              ...
              <Grid item xs>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2 }}>
                  <CustomStarRating value={company.rating} readOnly={true} showValue />
                  ...
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                    {company.reviews.map((review) => (
                      <Paper key={review.id} elevation={0} sx={{ p: 3 }}>
                        ...
                        <CustomStarRating value={review.rating} readOnly={true} />
